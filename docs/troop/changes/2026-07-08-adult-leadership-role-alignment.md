...
**Date:** 2026-07-08
**Affects:** `docs/troop/Troop_413_Policies.md`
**Status:** Proposed — pending Troop Committee review and vote

## 1. "Photo Release" section
...
## 3. "Official Functional Role Descriptions / Expectations" section

**Remove:** the entire section as currently written, including both the "Committee-Required Roles" and "Open Roles" tables.
...
**Add** (new paragraph, after the Assistant Scoutmaster definition):
...
Per "Committee Operating Structure," this requires a simple majority vote of Voting Members present with quorum met. Once approved: apply the edits above to `docs/troop/Troop_413_Policies.md`, bump the Revision History, and regenerate the PDF (`pnpm convert`).
